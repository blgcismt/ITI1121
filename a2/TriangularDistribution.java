...
public class TriangularDistribution {
	 ...
	 */
	public TriangularDistribution(int a, int c, int b) { //constructor for the class
		if ((a < c) && (c < b)) {
			this.a = a;
			this.c = c;
			this.b = b;
	 ...
	 */
	public Rational pdf(int x) { //method to calculate the probability density at point x
		if ((x < a) || (x > b)) {
